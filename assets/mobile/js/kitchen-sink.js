var myApp = new Framework7({modalTitle: 'Framework7', material: true,});
var $$ = Dom7;
...
myApp.onPageInit('swipe-delete modals media-lists', function (page) {
  var actionSheetButtons = [[{text: 'Choose some action', label: true}, {
    text: 'Alert', onClick: function () {
      myApp.alert('He Hoou!');
    }
  }, {
    text: 'Second Alert', onClick: function () {
      myApp.alert('Second Alert!');
    }
  }, {
    text: 'Nice Red Button ', color: 'red', onClick: function () {
...
myApp.onPageInit('messages', function (page) {
  ...
  }, {name: 'Blue Ninja', avatar: 'http://lorempixel.com/output/people-q-c-100-100-7.jpg'},];
...
var photoBrowserPage = myApp.photoBrowser({photos: photoBrowserPhotos, type: 'page'});
...
var photoBrowserLazy = myApp.photoBrowser({photos: photoBrowserPhotos, lazyLoading: true, theme: 'dark'});
...
myApp.onPageInit('notifications', function (page) {
  $$('.ks-notification-1').on('click', function () {
    myApp.addNotification({message: 'Simple message'});
  });
  $$('.ks-notification-2').on('click', function () {
    myApp.addNotification({message: 'Multi-line message. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc in magna nisi.',});
  });
  ...
  $$('.ks-notification-4').on('click', function () {
    myApp.addNotification({
      ...
      button: {text: 'Close', color: 'lightgreen'},
      onClose: function () {
...
myApp.onPageInit('calendar', function (page) {
  var calendarDefault = myApp.calendar({input: '#ks-calendar-default',});
  var calendarDateFormat = myApp.calendar({input: '#ks-calendar-date-format', dateFormat: 'DD, MM dd, yyyy'});
  var calendarMultiple = myApp.calendar({input: '#ks-calendar-multiple', dateFormat: 'M dd yyyy', multiple: true});
  var calendarRange = myApp.calendar({input: '#ks-calendar-range', dateFormat: 'M dd yyyy', rangePicker: true});
...
myApp.onPageInit('pickers', function (page) {
  ...
  var pickerDependent = myApp.picker({
    ...
    cols: [{
      textAlign: 'left', values: ['Japanese', 'German', 'American'], onChange: function (picker, country) {
