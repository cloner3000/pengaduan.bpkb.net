...
<div class="widget-box">
  <div class="widget-title">
    ...
    <h5>Formulir Pendaftaran Operator</h5>
  </div>
  <div class="widget-content">
<div id="pesan"></div>
<form id="fajax" class="form-horizontal" method="post" action="<?php echo site_url("operator/save"); ?>">
...
$(document).ready(function() {
  ...
  $('#bupdate').click(function() {
       ...
       if(typeof(id) ==='undefined'){
          ...
          getdetail(url+"operator/detail","id="+id);
       }
    });
   ...
   $('#bdelete').click(function() {
       ...
       if(typeof(id) ==='undefined'){
         ...
         $.post("<?=site_url("operator/delete")?>","id="+id).done(function() { oTable.fnDraw();})
  ...
  oTable = $('.data-table').dataTable({
     ...
     "bServerSide": true,
     "bDeferRender": true,
     "sAjaxSource": url+"operator/dataajax",
