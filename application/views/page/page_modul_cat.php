...
<div class="widget-box">
  <div class="widget-title">
    ...
    <h5>Formulir Modul Kategori</h5>
  </div>
  <div class="widget-content">
<div id="pesan"></div>
<form id="fajax" method="post" action="<?php echo site_url("modul_cat/save"); ?>">
<label>Modul Kategori</label>
  <input type="text" data-tag="input" placeholder="modul kategori" name="modul_cat" required="required" />
  <input type="hidden" data-tag="input" name="id"  />
<label>Icon</label>
  <input type="text" data-tag="input" placeholder="icon kategori" name="icon" required="required" />
...
<div class="widget-box">
  ...
  <thead>
    <tr>
      <th width="8%">Check</th>
      <th width="60%">Modul Kategori</th>
      <th width="60%">Icon Kategori</th>
    </tr>
  </thead>
  <tbody>
    <tr>
...
$(document).ready(function() {
  ...
  $('#bupdate').click(function() {
       ...
       if(typeof(id) ==='undefined'){
          ...
          getdetail(url+"modul_cat/detail","id="+id);
       }
    });
   ...
   $('#bdelete').click(function() {
       ...
       if(typeof(id) ==='undefined'){
         ...
         $.post("<?=site_url("modul_cat/delete")?>","id="+id).done(function() { oTable.fnDraw();})
  ...
  oTable = $('.data-table').dataTable({
     ...
     "bServerSide": true,
     "bDeferRender": true,
     "sAjaxSource": url+"modul_cat/dataajax",
