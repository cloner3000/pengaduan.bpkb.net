...
<div class="widget-box">
  <div class="widget-title">
    ...
    <h5>Formulir Topik</h5>
  </div>
  <div class="widget-content">
<div id="pesan"></div>
<form id="fajax" method="post" action="<?php echo site_url("ticket_topic/save"); ?>">
<label>Topik</label>
  <input type="text" data-tag="input" placeholder="tipe topic" name="topic" required="required" />
  <input type="hidden" data-tag="input" name="topic_id"  />
...
$(document).ready(function() {
  ...
  $('#bupdate').click(function() {
       ...
       if(typeof(id) ==='undefined'){
          ...
          getdetail(url+"ticket_topic/detail","id="+id);
       }
    });
   ...
   $('#bdelete').click(function() {
       ...
       if(typeof(id) ==='undefined'){
         ...
         $.post("<?=site_url("ticket_topic/delete")?>","id="+id).done(function() { oTable.fnDraw();})
  ...
  oTable = $('.data-table').dataTable({
     ...
     "bServerSide": true,
     "bDeferRender": true,
     "sAjaxSource": url+"ticket_topic/dataajax",
