...
<div class="widget-box">
  <div class="widget-title">
    ...
    <h5>Formulir Pengaturan</h5>
  </div>
  <div class="widget-content">
<div id="pesan"></div>
<form id="fajax" method="post" action="<?php echo site_url("setting_option/save"); ?>">
<label>Key / Value</label>
  <input type="text" data-tag="input" placeholder="key" name="key" required="required" />
  <input type="text" data-tag="input" placeholder="value" name="value" required="required" />
...
$(document).ready(function() {
  ...
  $('#bupdate').click(function() {
       ...
       if(typeof(id) ==='undefined'){
          ...
          getdetail(url+"setting_option/detail","id="+id);
       }
    });
   ...
   $('#bdelete').click(function() {
       ...
       if(typeof(id) ==='undefined'){
         ...
         $.post("<?=site_url("setting_option/delete")?>","id="+id).done(function() { oTable.fnDraw();})
  ...
  oTable = $('.data-table').dataTable({
     ...
     "bServerSide": true,
     "bDeferRender": true,
     "sAjaxSource": url+"setting_option/dataajax",
