...
<div class="widget-box">
  <div class="widget-title">
    ...
    <h5>Formulir Status</h5>
  </div>
  <div class="widget-content">
<div id="pesan"></div>
<form id="fajax" method="post" action="<?php echo site_url("ticket_status/save"); ?>">
<label>Status</label>
  <input type="text" data-tag="input" placeholder="tipe status" name="status" required="required" />
  <input type="hidden" data-tag="input" name="status_id"  />
...
$(document).ready(function() {
  ...
  $('#bupdate').click(function() {
       ...
       if(typeof(id) ==='undefined'){
          ...
          getdetail(url+"ticket_status/detail","id="+id);
       }
    });
   ...
   $('#bdelete').click(function() {
       ...
       if(typeof(id) ==='undefined'){
         ...
         $.post("<?=site_url("ticket_status/delete")?>","id="+id).done(function() { oTable.fnDraw();})
  ...
  oTable = $('.data-table').dataTable({
     ...
     "bServerSide": true,
     "bDeferRender": true,
     "sAjaxSource": url+"ticket_status/dataajax",
