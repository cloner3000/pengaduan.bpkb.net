...
class Setting_option extends CI_Controller{
    ...
    function dataajax(){
       echo $this->setting_option->dataajax();
    }
    ...
    function detail(){
      ...
      $data = $this->setting_option->detail($id);
    ...
    function save(){
      ...
      echo $this->setting_option->save($data);
    }
    ...
    function delete(){
      ...
      methodpage();
      $id = $this->input->post("id");
      $data = $this->setting_option->delete($id);
    }
}
