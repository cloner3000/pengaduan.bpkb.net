...
class Knowledgebase extends CI_Controller{
    ...
    function index(){
      ...
      $this->template->load("main_template", "page/page_knowledgebase", $data);
    }

    function dataajax(){
       echo $this->knowledgebase->dataajax();
    }
    ...
    function detail(){
      ...
      $data = $this->knowledgebase->detail($id);
    ...
    function save(){
      ...
      echo $this->knowledgebase->save($data);
    }
    ...
    function delete(){
      ...
      methodpage();
      $id = $this->input->post("id");
      $data = $this->knowledgebase->delete($id);
    }

    function test(){
      $data = array ();
      $this->load->view("form-common",$data);
    }
}
